...
+ (NSData *)gzipData:(NSData *)pUncompressedData
{
    ...
    if (initError != Z_OK)
    {
        ...
        case Z_VERSION_ERROR:
            errorMsg =
                @"The version of zlib.h and the version of the library linked "
                @"do not match.";
            break;
        default:
    ...
    NSMutableData *compressedData =
        [NSMutableData dataWithLength:[pUncompressedData length] * 1.01 + 12];
    ...
    if (deflateStatus != Z_STREAM_END)
    {
        ...
        case Z_ERRNO:
            ...
            break;
        case Z_STREAM_ERROR:
            errorMsg = @"The stream state was inconsistent (e.g., next_in or "
                @"next_out was NULL).";
            break;
        case Z_DATA_ERROR:
...
+ (NSData *)ungzipData:(NSData *)compressedData
{
    ...
    NSInteger full_length = [compressedData length];
    NSInteger half_length = [compressedData length] / 2;
